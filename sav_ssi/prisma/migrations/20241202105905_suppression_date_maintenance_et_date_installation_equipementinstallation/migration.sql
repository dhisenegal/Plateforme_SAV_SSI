/*
  ...
  - You are about to drop the column `dateInstallation` on the `installationequipement` table. All the data in the column will be lost.
  - You are about to drop the column `dateMaintenance` on the `installationequipement` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `installationequipement` DROP COLUMN `dateInstallation`,
