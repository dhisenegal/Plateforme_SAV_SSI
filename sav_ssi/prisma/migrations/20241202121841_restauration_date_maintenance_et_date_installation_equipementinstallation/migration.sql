/*
  ...
  - Added the required column `dateInstallation` to the `InstallationEquipement` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `installationequipement` ADD COLUMN `dateInstallation` DATETIME(3) NOT NULL,
    ADD COLUMN `dateMaintenance` DATETIME(3) NULL;
