/*
  ...
  - Added the required column `periodicite` to the `Contrat` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `contrat` ADD COLUMN `periodicite` VARCHAR(191) NOT NULL;
