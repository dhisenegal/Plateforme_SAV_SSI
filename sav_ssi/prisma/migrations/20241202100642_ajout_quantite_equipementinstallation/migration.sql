/*
  ...
  - Added the required column `quantite` to the `InstallationEquipement` table without a default value. This is not possible if the table is not empty.
...
-- AlterTable
ALTER TABLE `installationequipement` ADD COLUMN `quantite` INTEGER NOT NULL;
