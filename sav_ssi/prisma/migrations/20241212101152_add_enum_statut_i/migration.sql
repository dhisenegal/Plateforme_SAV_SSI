/*
  ...
  - You are about to alter the column `statut` on the `maintenance` table. The data in that column could be lost. The data in that column will be cast from `VarChar(191)` to `Enum(EnumId(2))`.
...
-- AlterTable
ALTER TABLE `maintenance` MODIFY `statut` ENUM('PROGRAMME', 'EN_COURS', 'SUSPENDU', 'TERMINE') NOT NULL DEFAULT 'PROGRAMME';
