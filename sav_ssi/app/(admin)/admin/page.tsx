...
import { Bar, BarChart, CartesianGrid, LabelList, XAxis, PieChart, Pie, Cell, Tooltip, ResponsiveContainer } from "recharts";
import { FaTools, FaClipboardList, FaCheckCircle, FaCalendarAlt } from "react-icons/fa";
import {
  Card,
  CardHeader,
  CardTitle,
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
        <Card className="bg-blue-300">
          <CardHeader className="flex items-center space-x-4">
            <FaTools size={30} className="text-blue-700" />
        ...
        <Card className="bg-yellow-300">
          <CardHeader className="flex items-center space-x-4">
            <FaClipboardList size={30} className="text-yellow-700" />
        ...
        <Card className="bg-red-300">
          <CardHeader className="flex items-center space-x-4">
            <FaCalendarAlt size={30} className="text-red-700" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Évolution des demandes de Janvier à Juin</CardDescription>
          </CardHeader>
          <CardContent>
