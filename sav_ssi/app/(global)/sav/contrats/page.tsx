...
import { FaPlus, FaSyncAlt, FaArrowLeft, FaArrowRight, FaSearch } from "react-icons/fa";
        ...
        <Dialog>
          ...
          <DialogContent className="w-[500px] p-6 bg-white rounded-lg shadow-lg">
            ...
            <div>
              ...
              {/* Enhanced Client Dropdown with Search and Scroll Functionality */}
              <div className="mb-4">
                ...
                <Popover open={clientComboOpen} onOpenChange={setClientComboOpen}>
                  <PopoverTrigger asChild>
                    ...
                    >
                      {newContract.client
                        ? clients.find(client => client.id === newContract.client)?.nom
                          ...
                          {filteredClients.map((client) => (
                            ...
                            >
                              <Check
                                className={cn(
                                  "mr-2 h-4 w-4",
                                  newContract.client === client.id ? "opacity-100" : "opacity-0"
                                )}
                              />
                              {client.nom}
                            </CommandItem>
              ...
              {/* Enhanced Site Dropdown with Scroll Functionality */}
              <div className="mb-4">
                ...
                <Popover open={siteComboOpen} onOpenChange={setSiteComboOpen}>
                  <PopoverTrigger asChild>
                    <Button
                      ...
                      className="w-full justify-between"
                      disabled={!newContract.client}
                    >
                      {newContract.site
                        ? sites.find(site => site.id === parseInt(newContract.site))?.nom
                        ...
                        <ScrollArea className="h-64">
                          {filteredSites.map((site) => (
                            <CommandItem
                              ...
                              value={site.nom}
                              onSelect={() => {
                                setNewContract({ ...newContract, site: site.id.toString() });
                            ...
                            >
                              <Check
                                className={cn(
                                  "mr-2 h-4 w-4",
                                  newContract.site === site.id.toString() ? "opacity-100" : "opacity-0"
                                )}
                              />
                              {site.nom}
                            </CommandItem>
